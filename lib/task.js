...
Task.prototype.map6 = function _map6(f, t2, t3, t4, t5, t6){
  ...
  return this.map(par6).ap(t2).ap(t3).ap(t4).ap(t5).ap(t6);
};
...
Task.prototype.map7 = function _map7(f, t2, t3, t4, t5, t6, t7){
  ...
  return this.map(par7).ap(t2).ap(t3).ap(t4).ap(t5).ap(t6).ap(t7);
};
...
Task.prototype.map8 = function _map8(f, t2, t3, t4, t5, t6, t7, t8){
  ...
  return this.map(par8).ap(t2).ap(t3).ap(t4).ap(t5).ap(t6).ap(t7).ap(t8);
};
...
Task.prototype.map9 = function _map9(f, t2, t3, t4, t5, t6, t7, t8, t9){
  ...
  return this.map(par9).ap(t2).ap(t3).ap(t4).ap(t5).ap(t6).ap(t7).ap(t8).ap(t9);
};
...
Task.prototype.map10 = function _map10(f, t2, t3, t4, t5, t6, t7, t8, t9, t10){
  ...
  return this.map(par10).ap(t2).ap(t3).ap(t4).ap(t5).ap(t6).ap(t7).ap(t8).ap(t9).ap(t10);
};
